...
<%
    try{ 
	 String email = (String)session.getAttribute("ses_email_cus"); 
	 Class.forName("com.mysql.jdbc.Driver");
     Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/online_store", "root", "root");
     String pass = "SELECT * FROM employees where email=?";
...
<h2>Your Password for <%= rs.getString("email")%> is  <%= rs.getString("pass") %></h2><br/><br/>
